...
## Error & Edge Cases
- Navigate to a page that doesn't exist — check for friendly 404
- Click the logo or home link — verify it returns to dashboard
- Check that logging out works — look for sign out button
